 ...
 *******************************************************************************/
package at.ac.tuwien.openbam.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/at/ac/tuwien/openbam/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
		...
		if (!isInWorkspace(org.eclipse.uml2.types.TypesPackage.class)) {
			resourceSet.getPackageRegistry().put(org.eclipse.uml2.types.TypesPackage.eINSTANCE.getNsURI(),
					org.eclipse.uml2.types.TypesPackage.eINSTANCE);
		}
		...
		if (!isInWorkspace(org.eclipse.uml2.uml.profile.standard.StandardPackage.class)) {
			resourceSet.getPackageRegistry().put(
					org.eclipse.uml2.uml.profile.standard.StandardPackage.eINSTANCE.getNsURI(),
		...
		String cppProfileNsUri = Usecase_profilePackage.eINSTANCE.getNsURI();
		String profilePath = "profile/usecase_profile.profile.uml#_11UeUHyiEe65Y-BI6bwPGw";

		// Register our uml profile package, if needed
		URI declaredURI = ePackageNsURIToProfileLocationMap.get(cppProfileNsUri);
		if (null == declaredURI) {
			System.err.println("Registering 'Use Case' profile");
			URI relativeURI = URI.createURI(profilePath);
			ePackageNsURIToProfileLocationMap.put(Usecase_profilePackage.eINSTANCE.getNsURI(), relativeURI);
		}
        ...
        uriMap.put(URI.createURI("pathmap:/OpenBAM/Models/usecase_profile.profile.uml"), 
        		URI.createURI("platform:usecase_profile/").appendSegment("profile").appendSegment(""));
        	
        Map<String, URI> ePackageNsURIToProfileLocationMap = UMLPlugin.getEPackageNsURIToProfileLocationMap();
		String cppProfileNsUri = "http:///schemas/usecase_profile/_CKDrABWYEe6f-fU5g2UYdw/0";//"http://schemas/usecase_profile";
		String profilePath = "../OpenBAM/Models/usecase_profile.profile.uml#_CKDrARWYEe6f-fU5g2UYdw";//"../OpenBAM/Models/usecase_profile.profile.uml#_CKDrABWYEe6f-fU5g2UYdw/0";
		...
		if (null == declaredURI) {
			...
			URI relativeURI = URI.createURI(profilePath);
			ePackageNsURIToProfileLocationMap.put(cppProfileNsUri, relativeURI);
		}*/
        
        //[Users, z003mshs, eclipse-workspace2, OpenBAM, Models, usecase.uml]
        /*
         * If you want to change the content of this method, do NOT forget to change the "@generated"
         * tag in the Javadoc of this method to "@generated NOT". Without this new tag, any compilation
         * of the Acceleo module with the main template that has caused the creation of this class will
